  ...
  <div class="article-inner">
    ...
    <div class="entry-meta">
      ...
      <?php comments_number('0',          // zero
        ...
        <div class="fb-like" data-href="<?php echo esc_url(the_permalink()); ?>" data-layout="button_count" data-action="like" data-size="small" data-show-faces="false" data-share="false"></div>
    </div>
